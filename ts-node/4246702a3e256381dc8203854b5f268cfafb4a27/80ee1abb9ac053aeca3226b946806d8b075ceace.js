...
var SeedConfig = (function () {
    function SeedConfig() {
        ...
        this.BOOTSTRAP_FACTORY_PROD_MODULE = (this.BOOTSTRAP_DIR + "/") + 'main-prod';
        this.APP_TITLE = 'Welcome to angular2-seed!';
        this.APP_SRC = "src/" + this.APP_CLIENT;
        this.ASSETS_SRC = this.APP_SRC + "/assets";
        this.CSS_SRC = this.APP_SRC + "/assets";
        ...
        this.NPM_DEPENDENCIES = [
            ...
            { src: 'rxjs/bundles/Rx.umd.min.js', inject: 'libs', env: exports.ENVIRONMENTS.DEVELOPMENT },
        ];
        this.APP_ASSETS = [];
        this.TEMP_FILES = [
            '**/*___jb_tmp___',
...
//# sourceMappingURL=/home/rafael/thesis_repository/SB-Admin-BS4-Angular-2-master/ts-node/4246702a3e256381dc8203854b5f268cfafb4a27/80ee1abb9ac053aeca3226b946806d8b075ceace.js.map